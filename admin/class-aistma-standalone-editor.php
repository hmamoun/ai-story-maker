...
class AISTMA_Standalone_Editor {
    ...
    public function enqueue_assets( $hook ) {
        ...
        error_log( 'AI Standalone Editor: Hook received: ' . $hook );
        ...
        if ( ! $current_screen || $current_screen->id !== 'edit_page_aistma-content-editor' ) {
            ...
            if ( ! isset( $_GET['page'] ) || $_GET['page'] !== 'aistma-content-editor' ) {
                error_log( 'AI Standalone Editor: Not on editor page. Screen ID: ' . ( $current_screen ? $current_screen->id : 'null' ) . ', Page param: ' . ( $_GET['page'] ?? 'not set' ) );
                return;
            }
        }
        
        error_log( 'AI Standalone Editor: Loading assets for editor page' );
        ...
        wp_localize_script( 'aistma-standalone-editor-js', 'aistmaStandaloneEditor', [
            ...
            'strings' => [
                ...
                'success' => __( 'Content saved successfully!', 'ai-story-maker' ),
            ]
        ] );
    }
    ...
    public function render_editor_page() {
        ...
        console.log('AI Standalone Editor: PHP page loaded');
        console.log('AI Standalone Editor: jQuery available:', typeof jQuery !== 'undefined');
        ...
        if (typeof aistmaStandaloneEditor === 'undefined') {
            console.log('AI Standalone Editor: Assets not loaded, loading manually...');
            ...
            script.onload = function() {
                console.log('AI Standalone Editor: JavaScript loaded manually');
                ...
                console.log('AI Standalone Editor: Localized data created manually:', window.aistmaStandaloneEditor);
            };
    ...
    public function handle_improve_content() {
        ...
        try {
            // Use the existing content editor handler
            $handler = new AISTMA_Content_Editor_Handler();
            $result = $handler->handle_improve_content_standalone( $content, $prompt, $operation_type );
            ...
            error_log( 'AI Standalone Editor Error: ' . $e->getMessage() );
